...
| [athrael-soju/colqwen3.5-v1](https://huggingface.co/athrael-soju/colqwen3.5-v1) | 90.9                                                                           | Apache 2.0 | • Based on `Qwen/Qwen3.5-4B` (hybrid GatedDeltaNet + full-attention).<br />• 320-dim ColBERT-style embeddings.<br />• 4.5B params, LoRA-trained.          | ✅                   |
