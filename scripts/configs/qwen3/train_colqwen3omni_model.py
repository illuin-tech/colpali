...
from colpali_engine.models import ColQwen3Omni, ColQwen3OmniProcessor
...
if __name__ == "__main__":
    ...
    config = ColModelTrainingConfig(
        ...
        processor=ColQwen3OmniProcessor.from_pretrained(
            pretrained_model_name_or_path="manu/colqwen3omni-base",
