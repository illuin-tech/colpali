...
def parse_args():
    ...
    parser.add_argument("--output-dir", type=str, required=True, help="Where to write model + script copy")
    parser.add_argument("--lr", type=float, default=2e-4, help="Learning rate")
    parser.add_argument("--tau", type=float, default=0.02, help="Temperature for loss function")
    parser.add_argument("--trainer", type=str, default="hf", choices=["torch", "hf"], help="Trainer to use")
    parser.add_argument("--loss", type=str, default="ce", choices=["ce", "pairwise"], help="Loss function to use")
    parser.add_argument("--peft", action="store_true", help="Use PEFT for training")
