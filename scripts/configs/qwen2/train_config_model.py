...
def parse_args():
    ...
    p.add_argument("--lr", type=float, required=True, help="learning rate for optimizer")
    p.add_argument("--tau", type=float, required=True, help="temperature for smooth‐max loss")
