...
config = ColModelTrainingConfig(
    output_dir="./models/colqwen2-ce-posaware-smoothamx-trainer-5e-0505",
    ...
    run_eval=True,
    loss_func=ColbertLoss(normalize_scores=True, use_smooth_max=True, pos_aware_negative_filtering=True),
