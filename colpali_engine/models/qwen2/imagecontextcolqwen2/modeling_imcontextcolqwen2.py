...
class ImageContextColQwen2(Qwen2VLForConditionalGeneration):
    """
    ...
    def from_pretrained(
        ...
        *args,
        ...
        embedd_passage_only: Optional[bool] = False,
        **kwargs,
    ):
    ...
    def get_index_images(self, processed):
        tokens_ids = processed["input_ids"]

        # get the index of the second occurence of the token idx 151652
        start_token_mask = tokens_ids == 151652
        second_start_token_mask = start_token_mask.cumsum(dim=1) == 2
        end_token_mask = tokens_ids == 151653
        before_second_end_token_mask = end_token_mask.cumsum(dim=1) == 1
