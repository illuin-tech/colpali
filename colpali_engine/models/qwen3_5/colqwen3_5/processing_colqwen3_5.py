...
class ColQwen3_5Processor(BaseVisualRetrieverProcessor, Qwen3VLProcessor):  # noqa: N801
    """
    Processor for ColQwen3.5.

    Uses Qwen3VLProcessor as the base since Qwen3.5 shares the same vision processing pipeline.
        ...
        **kwargs,
        ...
        if "max_num_visual_tokens" in kwargs:
            ...
            if patch_size is None or merge_size is None:
                raise ValueError("Image processor is missing `patch_size` or `merge_size`.")
    ...
    def get_n_patches(
        ...
        as a `Qwen3_5ForConditionalGeneration` attribute under `model.spatial_merge_size`.
        """
