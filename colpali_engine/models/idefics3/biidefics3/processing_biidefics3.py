...
class BiIdefics3Processor(BaseVisualRetrieverProcessor, Idefics3Processor):
    """
    ...
    def process_queries(
        ...
        """
        Process queries for BiIdefics3.
        """
        if suffix is None:
    ...
    def get_n_patches(
        ...
        raise NotImplementedError("This method is not implemented for BiIdefics3.")
