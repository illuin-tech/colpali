...
class TestIRDataset:
    ...
    @pytest.fixture(scope="class")
    def ir_dataset(self) -> Generator[IRDataset, None, None]:
    ...
    @pytest.fixture(scope="class")
    def ir_dataset_with_negs(self) -> Generator[IRDataset, None, None]:
        # Mock data for the dataset
        data = [
            {
                "query": "What is this?",
    ...
    @pytest.fixture(scope="class")
    def ir_dataset_with_corpus(self, corpus: IRDataset) -> Generator[IRDataset, None, None]:
        data = [
            {"query": "What is this?", "image": Image.new("RGB", (16, 16), color="red")},
        ]
        yield IRDataset(
    ...
    def test_ir_dataset_call(self, ir_dataset: IRDataset):
        result = ir_dataset[0]
    ...
    def test_ir_dataset_call_with_corpus(self, ir_dataset_with_corpus: IRDataset):
    ...
    def test_ir_dataset_call_with_neg_images(self, ir_dataset_with_negs: IRDataset):
