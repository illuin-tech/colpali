...
@pytest.fixture(scope="module")
def model_without_mask(model_name: str) -> Generator[ColQwen3_5, None, None]:
    device = get_torch_device("auto")
    logger.info(f"Device used: {device}")

    yield cast(
        ColQwen3_5,
        ColQwen3_5.from_pretrained(
            model_name,
...
@pytest.fixture(scope="module")
def model_with_mask(model_name: str) -> Generator[ColQwen3_5, None, None]:
    device = get_torch_device("auto")
    logger.info(f"Device used: {device}")
...
@pytest.fixture(scope="module")
def processor(model_name: str) -> Generator[ColQwen3_5Processor, None, None]:
