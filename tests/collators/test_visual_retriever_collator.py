...
class TestColPaliCollator:
    ...
    ) -> Generator[VisualRetrieverQACollator, None, None]:
        yield VisualRetrieverQACollator(processor=processor_from_pretrained)

    def test_colpali_collator_call(self, colpali_collator: VisualRetrieverQACollator):
    ...
    def test_colpali_collator_call_with_neg_images(self, colpali_collator: VisualRetrieverQACollator):
        example_image = Image.new("RGB", (16, 16), color="red")
